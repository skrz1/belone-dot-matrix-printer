...
drawer_folder = os.path.join(os.path.dirname(__file__), '..', 'paper_drawer')
...
os.makedirs(drawer_folder, exist_ok=True) # creating drawer if it does not exist for some reason (I'm looking at you, user)
filename_png = str(filename) + ".png"
new_filename_png = get_unique_filename(drawer_folder, filename_png)

file_path = os.path.join(drawer_folder, str(new_filename_png)) # path for raster file
